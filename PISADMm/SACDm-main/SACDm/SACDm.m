function [SACDresult,datadecon] = SACDm(imgstack, varargin)%cum,
%***************************************************************************
% SACD
%***************************************************************************
...
elseif ~isempty(params.psf)
    psf = params.psf;
    if ndims(params.psf) == 2
        psfv2 = fourierInterpolation(params.psf,[params.mag,params.mag],'lateral');
    else
